...
public class BackreferenceTransition extends Transition {
    ...
    public BackreferenceTransition(String anchor_info, Set<FifoInfo> fifos_info, State source, State target, Fifo fifo_to_match)
    {
        super(TransitionType.Backreference, anchor_info, fifos_info, source, target);
